...
// import "./App.css";
// import { MenuItem, Props, State } from "./type/Types";
...
//   const isLoggedIn = user && user.username === "admin" && user.password === "123";
...
//               alt="Company Logo"
//               style={{ width: collapsed ? 35 : 100, height: 'auto', margin: "10px auto", display: "flex" }} // Điều chỉnh kích thước và căn giữa
//             />
//           </Menu.Item>
//           <br />
//           {items.map((item) => {
...
//           />
//         </Header>
//         <div className="content" style={{ ...contentStyle, position: "relative" }}>
...
import { faApple } from "@fortawesome/free-brands-svg-icons"; // Icon brands
import "./App.css";
import { CurrentUser, MenuItem, Props, State } from "./type/Types";
import { Link, Navigate, Outlet } from "react-router-dom";
